...
class GameView(arcade.View):
    def __init__(self):
        ...
        #self.icon_section = IconSection (0,0,SCREEN_WIDTH = SCREEN_WIDTH, 299)
        #self.icon_section = IconSection (left=0, bottom=0, width=SCREEN_WIDTH, height= 299)
        

        #self.icon_section = IconSection (left=0, bottom=0, width=500, height= 299)
        self.icon_section = IconSection (0,0,SCREEN_WIDTH, 299)
        print(f" self.icon_section.__dict__     {self.icon_section.__dict__}")

        #for bidul in self.icon_section.__dict__:
        #    print(f"\n + {bidul}      {self.icon_section.__dict__[bidul]}+")
        ...
        #self.data_section = Datasec(left=0, bottom=300, width=500, height = 299)
