...
class Infostorage():
    ...
    def test_setup(self):
        ...
        self.list_of_rows = [['0','FileA.txt','99957 Kb', '12th Feb','50'],['1','ImageQ.png', '349 Kb', '1st Mar', '30'], ['2','Python_and_Rust.png', '349 Kb', '1st Mar', '20']]
...
class PieModalSection(Section):
    ...
    def on_draw(self):
        ...
        #myInfostorage.pie_col_index

        #---
        #self.list_of_rows = [['0','FileA.txt','99957 Kb', '12th Feb','40'],
        #['1','Wonderfull.txt', '349 Kb', '1st Mar', '30'],
        # ['2','Python_and_Rust.txt', '349 Kb', '1st Mar', '20'],
        # ['3','Mojo.txt', '149 Kb', '9st Mar', '10']]
        ...
        #mylabels= [elem for elem in myInfostorage.list_of_rows[1]]
...
class GameView(arcade.View):
    def __init__(self):
        ...
        print(f"7777777      class GameView(arcade.View) /init/   self.section_manager.add_section(self.modal_section)   ")
        ...
        "modal_section":self.modal_section,       
